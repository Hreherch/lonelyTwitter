...
/**
 * Handles putting tweets into the cloud :)
 */
...
public class ElasticSearchTweetController {
        ...
        protected ArrayList<NormalTweet> doInBackground(String... search_parameters) {
            ...
            try {
                ...
                if (result.isSucceeded()) {
                    ...
                    Log.i("Error", "failed to find any tweets that matched");
                }
            }catch (Exception e) {
        ...
        protected Void doInBackground(NormalTweet... tweets) {
            ...
            for ( NormalTweet tweet: tweets ) {
                ...
                try {
                    ...
                    Log.i("Oh god","We failed to add a tweet to elastic search");
                    e.printStackTrace();
                }
            }
    ...
    private static void verifySettings() {
        // if the client has not been initialized, we should make it
        if (client == null) {
